...
import com.usl.training.spring_boot_rest_api.bean.Student;
...
@GetMapping
    public ResponseEntity<List<Student>> getStudents(){
      ...
      students.add(new Student(1, "Ramesh","Fad"));
      students.add(new Student(2, "umesh", "Fad"));
  ...
  /// {id} -URL template variable
    ...
    // http://localhost:8080/students/query?id=1&firstName=Ramesh&lastName=Fad                             (Query Parameter)
    @GetMapping("query")
    ...
    //Spring boot API that handles HTTP PUT Request: updating exisiting resource
    ...
    //Spring bot REST API that handles HTTP DELETE Request : deleting the existing resource
